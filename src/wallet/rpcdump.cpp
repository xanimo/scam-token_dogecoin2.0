...
UniValue dumpprivkey(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() != 1)
        throw runtime_error(
            "dumpprivkey \"dogecoin2address\"\n"
            "\nReveals the private key corresponding to 'dogecoin2address'.\n"
            "Then the importprivkey can be used with this output\n"
            "\nArguments:\n"
            "1. \"dogecoin2address\"   (string, required) The dogecoin2 address for the private key\n"
            "\nResult:\n"
