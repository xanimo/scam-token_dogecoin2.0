...
const char* BIP71_MIMETYPE_PAYMENT = "application/dogecoin2-payment";
const char* BIP71_MIMETYPE_PAYMENTACK = "application/dogecoin2-paymentack";
const char* BIP71_MIMETYPE_PAYMENTREQUEST = "application/dogecoin2-paymentrequest";
    ...
    optionsModel(0)
{
    ...
    // on Mac: sent when you click dogecoin2: links
...
//
// OSX-specific way of handling dogecoin2: URIs and PaymentRequest mime types.
...
void PaymentServer::initNetManager()
{
    ...
    // netManager is used to fetch paymentrequests given in dogecoin2: URIs
