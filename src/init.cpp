...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/Dogecoin2-0>";
    const std::string URL_WEBSITE = "<http://www.Dogecoin2.org/>";
    ...
    return FormatParagraph(strprintf("Copyright (C) %i-%i The Bitcoin Core Developers", 2009, COPYRIGHT_YEAR)) + "\n" +
           ...
           "\n" +
           FormatParagraph(strprintf("Copyright (C) %i The Dogecoin2 Developers", 2021)) + "\n" +
           "\n" +
           FormatParagraph(strprintf(_("Please contribute if you find Dogecoin2 useful. "
