...
BOOST_AUTO_TEST_CASE(test_addresses)
{
    ...
    std::vector<std::string> pubkey = {"dogecoin2:qpm2qsznhks23z7629mms6s4cwef74vcwvy22gdx6a",
        "dogecoin2:qr95sy3j9xwd2ap32xkykttr4cvcu7as4y0qverfuy",
        "dogecoin2:qqq3728yw0y47sqn6l2na30mcw6zm78dzqre909m2r"};
    std::vector<std::string> script = {"dogecoin2:ppm2qsznhks23z7629mms6s4cwef74vcwvn0h829pq",
        "dogecoin2:pr95sy3j9xwd2ap32xkykttr4cvcu7as4yc93ky28e",
        "dogecoin2:pqq3728yw0y47sqn6l2na30mcw6zm78dzq5ucqzc37"};
